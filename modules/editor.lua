...
--  list:AddItem("allblock")
--  list:AddItem("downonly")
--  list:AddItem("instakill")
--  list:AddItem("water")
--	list:AddItem("save")
--	list:AddItem("breakable")
--	list:AddItem("trigger")
  self.Mode = "select"
	self.DrawMode = "path"
  self.Verts = {}
  self.Colors = {}
...
--function ags.btnEdBoxPath:OnClick()
--	Editor:ChangeDrawMode()
--end
--
--
--function ags.btnEdSwap:OnClick()
--  Editor.GUI.Y = Editor.GUI.Y == 0 and 160 or 0
--end
--
--function ags.btnEdNew:OnClick()
--  Editor:NewCollider()
--end
--
--function ags.btnEdDelete:OnClick()
--  Editor:DeleteCollider()
--end
--
--function ags.btnSaveRoom:OnClick()
--  CurrentRoom():SavePlatforms()
--end
